...
After `/test`. Plans YAML/MD → **base-tests** `/grill-testcase` (do not author plans here).

**Inputs (read):** hub `TC-*.yaml` + design testIds + `tests/e2e/`.
...
| Semantic | match `E2E-SEMANTIC-UI-ASSERTIONS.md` when plan has `assertions.semantic` |
