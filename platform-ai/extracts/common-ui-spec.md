...
- **Design registry:** `shared/portal-design.registry.json` — shadcn canonical; list default `#shell: DataListPage`. `.cursor/extracts/platform-design-registry.md`. Promotion: `docs/operational/DESIGN-REGISTRY-PROMOTION.md`.
