...
// Validate ../../src/app/(dashboard)/sample-items/page.tsx
{
  type __IsExpected<Specific extends AppPageConfig<"/sample-items">> = Specific
  const handler = {} as typeof import("../../src/app/(dashboard)/sample-items/page.js")
  type __Check = __IsExpected<typeof handler>
  // @ts-ignore
  type __Unused = __Check
}
